...
$PSQL_COMMAND "CREATE MATERIALIZED VIEW orbit_points_180 AS SELECT ST_Shift_Longitude(wkb_geometry) as aaa , operationmode, scetgeowhole, scetgeofrac, ephemeristime, geometryepoch, marssolarlongitude, marssundistance, orbitnumber, targetname, targetscpositionx, targetscpositiony, targetscpositionz, spacecraftaltitude, subsceastlongitude, subscplanetocentriclatitude, targetscvelocityx, targetscvelocityy, targetscvelocityz, targetscradialvelocity, targetsctangentialvelocity, localtruesolartime, solarzenithangle, dipoleunitx, dipoleunity, dipoleunitz, monopoleunitx, monopoleunity, monopoleunitz  FROM orbit_point;"
